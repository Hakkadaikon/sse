...
bool _log_dump_local(const int32_t fd, const char* str, const char* file, int line);
bool _var_dump_local(const int32_t fd, const char* str, const int32_t value);
bool _str_dump_local(const int32_t fd, const char* str, const char* value);
...
#define hex_dump(data, size) _hex_dump_local(data, size)
#define log_dump(fd, str) _log_dump_local(fd, str, __FILE__, __LINE__)
...
#define var_dump(fd, str, value) _var_dump_local(fd, str, value)
...
#define str_debug(str, value) _str_dump_local(STDOUT_FILENO, str, value)
#define str_info(str, value) _str_dump_local(STDOUT_FILENO, str, value)
#define str_error(str, value) _str_dump_local(STDERR_FILENO, str, value)
